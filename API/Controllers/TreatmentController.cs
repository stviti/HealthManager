...
namespace API.Controllers
{
    ...
    public class TreatmentController : Controller
    {
        ...
        public async Task<ActionResult<PaginationResponse<TreatmentDto>>> Get([FromBody] PaginatedFilter paginatedFilter = default)
        {
        ...
        [ProducesResponseType(StatusCodes.Status400BadRequest)]
        [ProducesResponseType(StatusCodes.Status500InternalServerError)]
        public async Task<ActionResult<TreatmentDto>> Get([FromRoute] Guid id)
        {
        ...
        [ProducesResponseType(StatusCodes.Status400BadRequest)]
        [ProducesResponseType(StatusCodes.Status500InternalServerError)]
        public async Task<ActionResult<BaseCommandResponse>> Create([FromBody] CreateTreatmentDto model)
        {
        ...
        [ProducesResponseType(StatusCodes.Status400BadRequest)]
        [ProducesResponseType(StatusCodes.Status500InternalServerError)]
        public async Task<ActionResult<BaseCommandResponse>> Update([FromBody] UpdateTreatmentDto model)
        {
